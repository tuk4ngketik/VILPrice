...
class _KacaSunroof extends State<KacaSunroof>{ 
  ...
  void initState() { 
    super.initState();
    setState(() { 
      data = pricevkoolController.kacaSunroof;
    });
    _getPriceList();
  }
          ...
          Expanded(
            ...
            child: EasyAutocomplete(
              decoration:   InputDecoration(
                ...
                suffixIcon: ( pricevkoolController.nilai_kacaSunroof!= 0 ) ? IconButton(
                  icon : const Icon(Icons.close),
                  onPressed: (){
                    setState(() =>  hargaJual = 0 );  
                    pricevkoolController.set_nilaiKacaSunroof(  hargaJual );
                    pricevkoolController.hitung_subTotal();  
                    pricevkoolController.set_filmKacaSunroof('-');
              ...
              onSubmitted: (v){
                  ...
                  pricevkoolController.set_nilaiKacaSunroof(  hargaJual );
                  pricevkoolController.hitung_subTotal(); 
                  pricevkoolController.set_filmKacaSunroof(v);
                  _total( pricevkoolController.diskon.toInt(),  pricevkoolController.subtotal.toInt() );
